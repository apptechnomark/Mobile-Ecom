/// Your profile UI screen
/// user can find all details like profile image, name, email id, mobile number
/// user can update profile image, name and mobile number
/// for email id change user navigate to edity email screen
/// user can also change password for that Change Password button by click on that user navigate to change password screen
...
import 'package:nineteenfive_e_commerce_app/screens/authentication/change_password.dart';
import 'package:nineteenfive_e_commerce_app/firebase/authentication/my_firebase_auth.dart';
import 'package:nineteenfive_e_commerce_app/screens/authentication/edit_email.dart';
...
import 'package:nineteenfive_e_commerce_app/widgets/text%20field/basic_text_field.dart';
...
class _YourProfileState extends State<YourProfile> {
  ...
  Future<void> validate(BuildContext context) async {
    if (formKey.currentState!.validate()) {
      ...
      bool result = await myFirebaseAuth.updateData(
          nameController.text, mobileNumberController.text, imageUrl ?? '');
      if (result) {
  ...
  void initState() {
    ...
    mobileNumberController =
        TextEditingController(text: StaticData.userData.mobileNumber);
  ...
  // Take url from firebase storage 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('Your Profile', style: Theme.of(context).textTheme.headline2),
        centerTitle: true,
      ),
      body: WillPopScope(
        onWillPop: () async {
