/// Landing screen
/// Include drawer as a user profile and cart icon, search field, product prosters, new arrival session, categories sessions
...
import 'package:nineteenfive_e_commerce_app/models/poster.dart';
import 'package:nineteenfive_e_commerce_app/models/product.dart';
import 'package:nineteenfive_e_commerce_app/screens/cart/cart_screen.dart';
import 'package:nineteenfive_e_commerce_app/screens/product/products.dart';
import 'package:nineteenfive_e_commerce_app/screens/home/search_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  // Get category name from data base
                    ...
                    PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            print("1234 topPosters[index].categoryId");
                          },
                          child: Container(
